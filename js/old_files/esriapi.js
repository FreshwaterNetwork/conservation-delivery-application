define([
  ...
  return declare(null, {
    initVue: function (t) {
      ...
      //   const vue = Vue.component("button-counter", {
      //     data: function () {
      //       return {
      //         count: 0,
      //       };
    ...
    esriApiFunctions: function (t) {
      ...
      t.url =
        "http://cirrus-web-adapter-241060755.us-west-1.elb.amazonaws.com/arcgis/rest/services/FN_Louisiana/CDA/MapServer";
      t.dynamicLayer = new ArcGISDynamicMapServiceLayer(t.url, {
        opacity: 0.7,
      });
      t.selectionSymbol = new SimpleFillSymbol(
      ...
      t.dynamicLayer.on("load", function () {
        ...
        t.map.on("click", (point) => {
          ...
          if (t.obj.appAreaVisible == "main") {
            ...
            console.log(
              "only allow clicks when on the main section of the app"
            );
          }
        });
      });
          ...
          qt.execute(q, function (e) {
            ...
            if (e.features.length > 0) {
              ...
              if (t.obj["cda-data-object"]["local-option"]) {
                if (
                  t.obj["cda-data-object"]["local-option-selections"].indexOf(
                    e.features[0].attributes.fid_1
                  ) == -1
                ) {
                  t.obj["cda-data-object"]["local-option-selections"].push(
                    e.features[0].attributes.fid_1
                  );
                  map.graphics.add(
                ...
                if (t.obj["cda-data-object"]["resource-option"]) {
                  if (
                    t.obj["cda-data-object"][
                      "resource-option-selections"
                    ].indexOf(e.features[0].attributes.RU) == -1
                  ) {
                    t.obj["cda-data-object"]["resource-option-selections"].push(
                      e.features[0].attributes.RU
                    );
                    map.graphics.add(
                      new Graphic(e.features[0].geometry, t.selectionSymbol, {
                  ...
                  if (
                    t.obj["cda-data-object"]["huc-option-selections"].indexOf(
                      e.features[0].attributes.gid
                    ) == -1
                  ) {
                    t.obj["cda-data-object"]["huc-option-selections"].push(
                      e.features[0].attributes.gid
                    );
                    map.graphics.add(
                      new Graphic(e.features[0].geometry, t.selectionSymbol, {
                  ...
                  if (
                    ...
                    ].indexOf(e.features[0].attributes.featureid) == -1
                  ) {
                    t.obj["cda-data-object"][
                      "catchment-option-selections"
                    ].push(e.features[0].attributes.featureid);
                    map.graphics.add(
                      new Graphic(e.features[0].geometry, t.selectionSymbol, {
                  ...
                  t.obj["cda-data-object"]["area-selected"] =
                    "catchment-option";
                }
              }
    ...
    handleAreaSelections: function (t) {
      ...
      $.each(
        t.obj["cda-data-object"][
          `${t.obj["cda-data-object"]["area-selected"]}-selections`
        ],
        (i, v) => {
          let idText = "";
          if (t.obj["cda-data-object"]["local-option"]) {
          ...
          if (v) {
            if (v.attributes) {
              if (id == v.attributes.id) {
                ...
                let index = t.obj["cda-data-object"][
                  `${t.obj["cda-data-object"]["area-selected"]}-selections`
                ].indexOf(v.attributes.id);
                if (index > -1) {
                  t.obj["cda-data-object"][
                    `${t.obj["cda-data-object"]["area-selected"]}-selections`
                  ].splice(index, 1);
    ...
    handleAreaSelectionsCounter: function (t) {
      ...
      if (t.obj["cda-data-object"]["local-option"]) {
        t.obj["cda-data-object"]["area-selected-counter"] =
          t.obj["cda-data-object"]["local-option-selections"].length;
      } else {
        if (t.obj["cda-data-object"]["huc-option"]) {
          t.obj["cda-data-object"]["area-selected-counter"] =
            t.obj["cda-data-object"]["huc-option-selections"].length;
        } else if (t.obj["cda-data-object"]["catchment-option"]) {
          t.obj["cda-data-object"]["area-selected-counter"] =
            t.obj["cda-data-object"]["catchment-option-selections"].length;
        } else if (t.obj["cda-data-object"]["resource-option"]) {
          t.obj["cda-data-object"]["area-selected-counter"] =
            t.obj["cda-data-object"]["resource-option-selections"].length;
        }
      }
      // disable and enable BMP button based on the number of areas selected
      $(".cda-number-selected-area span").html(
        t.obj["cda-data-object"]["area-selected-counter"]
      );
